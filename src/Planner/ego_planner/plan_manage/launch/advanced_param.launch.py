...
def generate_launch_description():
    ...
    frame_id = LaunchConfiguration('frame_id', default='world')
    ...
    frame_id_arg = DeclareLaunchArgument('frame_id', default_value=frame_id, description='World frame id for mapping/visualization')
