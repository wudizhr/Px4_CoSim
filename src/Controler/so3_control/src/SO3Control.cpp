                                  ...
                                  const Eigen::Vector3d &kv)
{
  ...
  // std::cout << "Flag Use Pos: " << flag_use_pos << std::endl;
  // std::cout << "Flag Use Vel: " << flag_use_vel << std::endl;
  // std::cout << "Flag Use Acc: " << flag_use_acc << std::endl;
  ...
  // std::cout << "des_vel: " << des_vel.transpose() << std::endl;
  // std::cout << "acc_: " << acc_.transpose() << std::endl;
  // std::cout << "des_acc: " << des_acc.transpose() << std::endl;

  // 计算力
  force_ = mass_ * g_ * Eigen::Vector3d(0, 0, -1);  //测出来的无人机质量，这里直接写死 2.49kg 
  // std::cout << "Gravity Force: " << force_.transpose() << std::endl;
  ...
  //  std::cout << "Computed Force: " << force_.transpose() << std::endl;
  ...
  // std::cout << "des_yaw (deg): " << des_yaw * 180.0 / M_PI << std::endl;
  // std::cout << "force_.normalized : " << force_.normalized().transpose() << std::endl;
  if (force_.norm() > 1e-6)
